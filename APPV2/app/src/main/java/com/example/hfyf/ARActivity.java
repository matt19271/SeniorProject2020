...
public class ARActivity extends AppCompatActivity implements SurfaceHolder.Callback, AREventListener {
    ...
    private void initializeDeepAR() {
        ...
        deepAR.setLicenseKey("ff9466dafa0ffc2b3db73cb8e228a95e4e04d9034260ca31b4ee158f6d0206ef8dbb55b5d31db074");
    ...
    public void screenshotTaken(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(ARActivity.this, "Screenshot saved", Toast.LENGTH_SHORT).show();
        } catch (Throwable e) {
            e.printStackTrace();
        }
